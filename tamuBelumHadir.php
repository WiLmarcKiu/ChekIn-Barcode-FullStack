                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">
                            ...
                            </span> Tamu Belum Hadir
                        </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Tamu Belum Hadir</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Daftar Tamu Belum Hadir</h4>
                            <hr>
                            <div class="table-responsive">
                                <table id="example1" class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php $nomor = 1; ?>
                                        <?php $ambil = $koneksi->query("SELECT * FROM tamu LEFT JOIN kategori ON tamu.id_kategori=kategori.id_kategori WHERE status = 'Belum Hadir' ORDER BY id_tamu DESC"); ?>
